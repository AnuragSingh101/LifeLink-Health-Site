...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-pink-100 to-gray-50 flex items-center justify-center">
      <div className="bg-white p-10 rounded-xl shadow-lg w-full max-w-6xl">
        {/* Main Title */}
        <h1 className="text-5xl font-bold text-center text-red-500 mb-8">About Life Link</h1>

        {/* Introduction Paragraph */}
        <p className="text-gray-700 text-lg leading-relaxed mb-8 text-center max-w-3xl mx-auto">
          <span className="font-bold text-red-500">Life Link (LL)</span> is an innovative web-based platform 
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 text-lg leading-relaxed mb-4 max-w-3xl mx-auto">
            By centralizing and streamlining the blood donation process, <span className="font-bold text-red-500">Life Link (LL)</span> plays a crucial 
