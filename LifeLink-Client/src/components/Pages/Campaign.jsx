...
const CampaignsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-50 via-pink-100 to-gray-50 p-6">
      <h1 className="text-4xl font-bold text-center text-red-500 mb-8">Upcoming Blood Donation Campaigns</h1>
